...
import models.{ImprovementsRebasedModel, IsClaimingImprovementsModel}
import play.api.data.Forms._
import play.api.data._
import uk.gov.voa.play.form.ConditionalMappings.{isEqual, mandatoryIf}

object ImprovementsRebasedForm {

  val improvementsRebasedForm =
      Form(mapping(
        "improvementsAmt" ->
      ...
      )(ImprovementsRebasedModel.apply)(ImprovementsRebasedModel.unapply))
