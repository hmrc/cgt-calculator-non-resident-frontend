...
object DisposalCostsModel {
  ...
  val postWrites: Writes[DisposalCostsModel] = new Writes[DisposalCostsModel] {
    override def writes(model: DisposalCostsModel): JsValue = {
      Json.toJson(model.disposalCosts)
    }
  }
