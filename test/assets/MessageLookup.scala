...
object MessageLookup {
  ...
  object NonResident extends Common {
    ...
    object Summary {
      ...
      val userBannerHelpYes = "Help improve this digital service by joining the HMRC user panel (opens in new window)"
      val userBannerHelpNo = "No thanks"

      val userBannerLink = "https://signup.take-part-in-research.service.gov.uk/?utm_campaign=CGT_non_resident_summary&utm_source=Survey_Banner&utm_medium=other&t=HMRC&id=116"
