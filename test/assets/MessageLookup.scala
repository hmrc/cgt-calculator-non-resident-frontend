...
//      def errorMaximum(value: String): String = s"Enter an amount that's £$value or less"
    ...
    object AcquisitionValue {
      ...
      val helpText = "If you owned the property with someone else, only enter your share of the purchase. Enter the amount in pounds. For example, £150,000"
    ...
    object CurrentIncome {
      ...
      val title = "Total UK income in the tax year when you stopped owning the property"
...
//      val errorInvalid = "Invalid customer type"
    ...
    object DisposalCosts {
      ...
      val title = "Cost paid when you stopped owning the property"
    ...
    object DisposalValue {
      ...
      val jointOwnership = "If you owned the property with someone else, only enter your share of the sale value. Enter the amount in pounds. For example, £250,000"
      def errorMaximum(value: String): String = s"Enter an amount that's £$value or less"
    }
    ...
    object PersonalAllowance {
      ...
      val title = "Personal Allowance in the tax year when you stopped owning the property"
    ...
    object RebasedCosts {
      ...
      val jointOwnership = "If you owned the property with someone else, only enter your share of the cost, as agreed with your co-owner. Enter the amount in pounds. For example, £10,000.50"
      val errorNegative = "Enter a positive number for your costs"
    ...
    object CostsAtLegislationStart {
      ...
      val helpText = "If you owned the property with someone else, only enter your share of the costs, as agreed with your co-owner. Enter the amount in pounds. For example, £10,000.50"
      val errorNegative = "Enter a positive number for your costs"
      val errorNoValue = "Enter the value for your costs"
      val errorDecimalPlaces = "There are too many numbers after the decimal point in your costs"
