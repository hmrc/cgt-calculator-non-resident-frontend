...
import views.html.calculation.{boughtForLess, livedInProperty}
import play.api.i18n.Messages.Implicits._
import play.api.Play.current
import play.api.data.Form

class LivedInPropertyViewSpec extends UnitSpec with WithFakeApplication with MockitoSugar with FakeRequestHelper with AssertHelpers {
  ...
  "Bought for less view" when {
    ...
    "supplied with no errors" should {
      ...
      lazy val view = livedInProperty(form)
